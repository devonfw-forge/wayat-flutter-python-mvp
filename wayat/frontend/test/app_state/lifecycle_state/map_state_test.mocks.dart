...
// in wayat/test/app_state/lifecycle_state/map_state_test.dart.
...
class MockLifeCycleService extends _i1.Mock implements _i6.LifeCycleService {
...
class MockHttpProvider extends _i1.Mock implements _i2.HttpProvider {
  ...
  @override
  _i7.Future<Map<String, String>> getHeaders() => (super.noSuchMethod(
        Invocation.method(
          #getHeaders,
          [],
        ),
  ...
  @override
  _i7.Future<bool> sendDelRequest(String? subPath) => (super.noSuchMethod(
        Invocation.method(
          #sendDelRequest,
          [subPath],
        ),
