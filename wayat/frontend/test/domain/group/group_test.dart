...
void main() {
  ...
  test("Check String conversion", () {
    expect(group.toString(),
        "Group(id: id, members: [Contact(id: id, name: name, email: mail@mail.com, imageUrl: https://example.com/contact, phone: +34123456789, shareLocation: true)], name: name, imageUrl: https://example.com/group)");
  });
