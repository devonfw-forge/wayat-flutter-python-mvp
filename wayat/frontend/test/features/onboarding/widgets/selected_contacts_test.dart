...
void main() async {
  ...
  setUpAll(() async {
    ...
    when(controller.selectedContacts)
      .thenAnswer((_) => [contactA, contactB]);
    when(controller.moveBack())
      .thenAnswer((_) => false);
  ...
  testWidgets('SelectedContacts has a CustomTextIconButton',
      (tester) async {
  ...
  testWidgets('SelectedContacts has a CustomOutlinedButton',
      (tester) async {
    await tester.pumpWidget(createApp(SelectedContacts()));
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('Tap on CustomTextIconButton moves back',
      (tester) async {
    await tester.pumpWidget(createApp(SelectedContacts()));
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('Tap on CustomOutlinedButton moves back',
      (tester) async {
    await tester.pumpWidget(createApp(SelectedContacts()));
    await tester.pump(const Duration(seconds: 1));
