...
class _FakeContactsAddressServiceImpl_2 extends _i1.SmartFake
  ...
  _FakeContactsAddressServiceImpl_2(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class _FakeObservableMap_4<K, V> extends _i1.SmartFake
  ...
  _FakeObservableMap_4(Object parent, Invocation parentInvocation)
      : super(parent, parentInvocation);
}
...
class MockOnboardingController extends _i1.Mock
  ...
  _i5.ContactService get contactService => (super.noSuchMethod(
          ...
          returnValue:
              _FakeContactService_3(this, Invocation.getter(#contactService)))
      as _i5.ContactService);
  @override
  _i10.OnBoardingState get onBoardingState => (super.noSuchMethod(
      Invocation.getter(#onBoardingState),
      returnValue: _i10.OnBoardingState.notStarted) as _i10.OnBoardingState);
  @override
  set onBoardingState(_i10.OnBoardingState? value) =>
      super.noSuchMethod(Invocation.setter(#onBoardingState, value),
          returnValueForMissingStub: null);
  @override
  _i11.OnBoardingProgress get currentPage =>
  ...
  @override
  set currentPage(_i11.OnBoardingProgress? value) =>
      super.noSuchMethod(Invocation.setter(#currentPage, value),
          returnValueForMissingStub: null);
  @override
  _i3.ObservableMap<_i12.Contact, bool> get contacts =>
  ...
  set contacts(_i3.ObservableMap<_i12.Contact, bool>? value) =>
      super.noSuchMethod(Invocation.setter(#contacts, value),
          returnValueForMissingStub: null);
  @override
  List<_i12.Contact> get contactList =>
      (super.noSuchMethod(Invocation.getter(#contactList),
          returnValue: <_i12.Contact>[]) as List<_i12.Contact>);
  @override
  List<_i12.Contact> get selectedContacts =>
      (super.noSuchMethod(Invocation.getter(#selectedContacts),
          returnValue: <_i12.Contact>[]) as List<_i12.Contact>);
  @override
  List<_i12.Contact> get unselectedContacts =>
  ...
  void importContacts() =>
      super.noSuchMethod(Invocation.method(#importContacts, []),
          returnValueForMissingStub: null);
  @override
  bool isSelected(_i12.Contact? contact) =>
      (super.noSuchMethod(Invocation.method(#isSelected, [contact]),
          returnValue: false) as bool);
  @override
  void finishOnBoarding(_i13.BuildContext? context) =>
      super.noSuchMethod(Invocation.method(#finishOnBoarding, [context]),
          returnValueForMissingStub: null);
  @override
  void progressTo(_i11.OnBoardingProgress? newPage) =>
  ...
  bool moveBack() =>
      (super.noSuchMethod(Invocation.method(#moveBack, []), returnValue: false)
          as bool);
  @override
  void updateSelected(_i12.Contact? contact) =>
      super.noSuchMethod(Invocation.method(#updateSelected, [contact]),
          returnValueForMissingStub: null);
  @override
  void addAll(List<_i12.Contact>? contactList) =>
      super.noSuchMethod(Invocation.method(#addAll, [contactList]),
          returnValueForMissingStub: null);
  @override
  void setOnBoardingState(_i10.OnBoardingState? state) =>
