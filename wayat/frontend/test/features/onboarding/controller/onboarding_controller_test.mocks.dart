...
class MockOnboardingController extends _i1.Mock
  ...
  @override
  _i7.OnBoardingState get onBoardingState => (super.noSuchMethod(
        Invocation.getter(#onBoardingState),
        returnValue: _i7.OnBoardingState.notStarted,
      ) as _i7.OnBoardingState);
  @override
  set onBoardingState(_i7.OnBoardingState? value) => super.noSuchMethod(
        Invocation.setter(
          #onBoardingState,
          value,
        ),
  ...
  @override
  _i8.OnBoardingProgress get currentPage => (super.noSuchMethod(
        Invocation.getter(#currentPage),
        returnValue: _i8.OnBoardingProgress.initialManageContactsTip,
      ) as _i8.OnBoardingProgress);
  @override
  set currentPage(_i8.OnBoardingProgress? value) => super.noSuchMethod(
        Invocation.setter(
          #currentPage,
          value,
        ),
  ...
  @override
  _i4.ObservableMap<_i9.Contact, bool> get contacts => (super.noSuchMethod(
  ...
  @override
  List<_i9.Contact> get contactList => (super.noSuchMethod(
        Invocation.getter(#contactList),
        returnValue: <_i9.Contact>[],
      ) as List<_i9.Contact>);
  @override
  List<_i9.Contact> get selectedContacts => (super.noSuchMethod(
        Invocation.getter(#selectedContacts),
        returnValue: <_i9.Contact>[],
      ) as List<_i9.Contact>);
  @override
  List<_i9.Contact> get unselectedContacts => (super.noSuchMethod(
  ...
  @override
  bool isSelected(_i9.Contact? contact) => (super.noSuchMethod(
        Invocation.method(
          #isSelected,
          [contact],
        ),
  ...
  @override
  void progressTo(_i8.OnBoardingProgress? newPage) => super.noSuchMethod(
        Invocation.method(
          #progressTo,
          [newPage],
        ),
  ...
  @override
  void updateSelected(_i9.Contact? contact) => super.noSuchMethod(
        Invocation.method(
          #updateSelected,
          [contact],
        ),
  ...
  @override
  void addAll(List<_i9.Contact>? contactList) => super.noSuchMethod(
        Invocation.method(
          #addAll,
          [contactList],
        ),
  ...
  @override
  void setOnBoardingState(_i7.OnBoardingState? state) => super.noSuchMethod(
        Invocation.method(
          #setOnBoardingState,
          [state],
        ),
...
class MockContactService extends _i1.Mock implements _i3.ContactService {
  ...
  @override
  _i10.Future<bool> removeContact(_i9.Contact? contact) => (super.noSuchMethod(
        Invocation.method(
          #removeContact,
          [contact],
        ),
...
class MockSessionState extends _i1.Mock implements _i12.SessionState {
  ...
  @override
  set currentUser(_i13.MyUser? value) => super.noSuchMethod(
        Invocation.setter(
          #currentUser,
          value,
        ),
